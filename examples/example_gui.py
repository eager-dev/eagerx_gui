...
if __name__ == "__main__":
    ...
    name = gym_id.split("-")[0]
    obj = eagerx.Object.make("GymObject", name, env_id=gym_id, rate=rate, default_action=0, render_shape=[300, 300])
    ...
    # Define bridge
    bridge = eagerx.Bridge.make("GymBridge", rate=rate, is_reactive=True, real_time_factor=1,
