...
class Ui_Form(object):
    def setupUi(self, Form):
        ...
        # self.showCompatibleEnginesBtn = QtWidgets.QPushButton(Form)
        # self.showCompatibleEnginesBtn.setObjectName("showCompatibleEnginesBtn")
        # self.gridLayout.addWidget(self.showCompatibleEnginesBtn, 4, 3, 1, 1)
    ...
    def retranslateUi(self, Form):
        ...
        # self.showCompatibleEnginesBtn.setText(_translate("Form", "Compatible Engines"))
